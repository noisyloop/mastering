/**
 * DSP Worker Interface
 * Provides a Promise-based API for communicating with the DSP Web Worker
 *
 * Usage:
 *   const dspWorker = new DSPWorkerInterface();
 *   const { lufs } = await dspWorker.measureLUFS(audioBuffer);
